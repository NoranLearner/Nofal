...
@section('content')
        ...
        <div class="col-xl-3 col-md-6 col-sm-6 p-2">
            <div class="box-card mini animate__animated animate__flipInY   "><i class="fab far fa-chart-bar b-first" aria-hidden="true"></i>
                ...
                <p class="mt-3 mb-1 text-center">
                    <i class="far fas fa-wallet mr-1 c-first"></i>Your main list is growing
                </p>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-6 p-2">
            <div class="box-card mini animate__animated animate__flipInY    "><i class="fab far fa-clock b-second" aria-hidden="true"></i>
                <span class="c-second">Visitors</span>
                <span>27</span>
                <p class="mt-3 mb-1 text-center">
                    <i class="far fas fa-wifi mr-1 c-second"></i>Your main list is growing
                </p>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-6 p-2">
            <div class="box-card mini animate__animated animate__flipInY   "><i class="fab far fa-comments b-third" aria-hidden="true"></i>
                <span class="c-third">Messages</span>
                <span>5</span>
                <p class="mt-3 mb-1 text-center">
                    <i class="fab fa-whatsapp mr-1 c-third"></i>Your main list is growing
                </p>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-6 p-2">
            <div class="box-card mini animate__animated animate__flipInY   "><i class="fab far fa-gem b-forth" aria-hidden="true"></i>
                <span class="c-forth">Mined</span>
                <span>555,223</span>
                <p class="mt-3 mb-1 text-center">
                    <i class="fab fa-bluetooth mr-1 c-forth"></i>Your main list is growing
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-1 col-sm-1 col-md-4 col-lg-4 p-2">
            <div class="card flat f-first h-100">
                <div class="card-body">
                    ...
                    <hr>
                    <a class="weatherwidget-io" href="https://forecast7.com/en/37d5545d08/urmia/" data-label_1="URMIA"
                        data-label_2="WEATHER" data-icons="Climacons Animated" data-days="5"
    ...
    <div class="row mb-2 m-2">
        <div class="col-xl-8 col-md-6 col-sm-6 p-2">
            <div class="box-dash h-100 pastel animate__animated animate__flipInY b-second   "><i class="fab far fa-clock"
                    aria-hidden="true"></i>
            ...
            <div id="accordion " class="accordion card shade outlined o-forth w-100">
                ...
                <div class="">
                    <div class="card-header mr-3 ml-3 pr-0 pl-0" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link c-grey collapsed w-100 m-0 text-left" data-toggle="collapse"
